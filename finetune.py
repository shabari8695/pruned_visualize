...
class PrunningFineTuner_VGG16:
	...
	def train_epoch(self, optimizer = None, rank_filters = False):
		...
		for batch, label in self.train_data_loader:
			print("batch {} of {}".format(batch_count,len(self.train_data_loader)))
	...
	def prune(self):
		...
		#Since we train on a really small dataset, after one iteration of pruning the accuracy is pretty good
		for _ in range(1):#range(iterations):
		...
		self.train(optimizer, epoches = 1)
		torch.save(model.state_dict(), "model_prunned_state_1")
...
def get_args():
	...
	parser.add_argument("--train_path", type = str, default = "test")
